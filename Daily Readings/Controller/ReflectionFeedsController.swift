//
//  ReflectionFeedsController.swift
//  Daily Readings
//
...
class ReflectionFeedsController: UICollectionViewController {
    
    var data: ReflectionCategories?
    ...
    override func viewDidLoad() {
        ...
        self.collectionView!.register(ReflectionFeedsCell.self, forCellWithReuseIdentifier: reuseIdentifier)
...
extension ReflectionFeedsController: UICollectionViewDelegateFlowLayout {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: reuseIdentifier, for: indexPath) as! ReflectionFeedsCell
...
extension ReflectionFeedsController: ReflectionFeedsCellDelegate {
